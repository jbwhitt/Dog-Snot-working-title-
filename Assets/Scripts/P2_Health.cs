...
public class P2_Health : MonoBehaviour {
    ...
    void Update()
    {
        if (GameObject.FindGameObjectWithTag("Player 2").GetComponent<Player2>().health == 5)
        {
        ...
        else if (GameObject.FindGameObjectWithTag("Player 2").GetComponent<Player2>().health == 4)
        {
            this.transform.GetChild(0).transform.gameObject.SetActive(false);
            this.transform.GetChild(1).transform.gameObject.SetActive(true);
            this.transform.GetChild(2).transform.gameObject.SetActive(true);
        ...
        else if (GameObject.FindGameObjectWithTag("Player 2").GetComponent<Player2>().health == 3)
        {
            this.transform.GetChild(0).transform.gameObject.SetActive(false);
            this.transform.GetChild(1).transform.gameObject.SetActive(false);
            this.transform.GetChild(2).transform.gameObject.SetActive(true);
        ...
        else if (GameObject.FindGameObjectWithTag("Player 2").GetComponent<Player2>().health == 2)
        {
            this.transform.GetChild(0).transform.gameObject.SetActive(false);
            this.transform.GetChild(1).transform.gameObject.SetActive(false);
            this.transform.GetChild(2).transform.gameObject.SetActive(false);
        ...
        else if (GameObject.FindGameObjectWithTag("Player 2").GetComponent<Player2>().health == 1)
        {
            this.transform.GetChild(0).transform.gameObject.SetActive(false);
            this.transform.GetChild(1).transform.gameObject.SetActive(false);
            this.transform.GetChild(2).transform.gameObject.SetActive(false);
        ...
        else if (GameObject.FindGameObjectWithTag("Player 2").GetComponent<Player2>().health == 0)
        {
            this.transform.GetChild(0).transform.gameObject.SetActive(false);
            this.transform.GetChild(1).transform.gameObject.SetActive(false);
            this.transform.GetChild(2).transform.gameObject.SetActive(false);
